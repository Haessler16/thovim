...
/**
 * The original portfolio homepage, unchanged.
 *
 * It used to live at `/`. When the HAESSLER OS experience took over `/`, this
 * content moved here verbatim so nothing was deleted: it still renders inside
 * the legacy shell (Navbar + VoxelDog) and keeps EN/ES/PT from the legacy
 * dictionary. Reachable from the system navigation and the footer as
 * "Classic Portfolio".
 */
